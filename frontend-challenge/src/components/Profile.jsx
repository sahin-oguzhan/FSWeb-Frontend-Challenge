...
export default function Profile() {
  ...
  return (
    <div className="max-h-[355px] flex flex-col border-t-2 border-indigo-200">
      ...
      <div className="flex flex-row w-full gap-x-8">
            ...
            <tbody>
              {data.profile.profileList.map((profile, index) => (
                <tr key={index}>
                  ...
                  <td className="font-inter text-lg text-[#000000] font-normal align-top pb-2 dark:text-[#FFFFFF]">
                    {profile.item}
                  </td>
                </tr>
              ))}
        ...
        <div className="flex flex-col w-1/2 items-start justify-start h-full pt-0">
