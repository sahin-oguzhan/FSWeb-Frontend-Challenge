...
export default function Footer() {
  ...
  return (
    <div className=" max-h-[409px] flex flex-col justify-center pb-11 bg:gray py-[70px]">
      <h1 className="text-[#1F2937] font-inter font-semibold leading-[1.25] text-[42px] whitespace-pre-line dark:text-[#AEBCCF]">
        {data.desc}
      </h1>
      <div className="flex flex-row justify-between max-w-7xl mt-11">
        <a
